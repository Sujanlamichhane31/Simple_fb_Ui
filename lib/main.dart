...
class _HomePageState extends State<HomePage> {
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: ListView(
                  ...
                  children: <Widget>[
                    makeStory(storyImage: 'assets/story/IMG_0079.JPG',
                        userImage: 'assets/god.jpg',
                        userName: 'God of War'),
                    makeStory(storyImage: 'assets/story/IMG_7014.JPG',
                        userImage: 'assets/gta.jpg',
                        userName: 'Gta gang'),
                    makeStory(storyImage: 'assets/story/IMG_7040.JPG',
                        userImage: 'assets/mad.jpg',
                        userName: 'Mad Max'),
                    makeStory(storyImage: 'assets/story/IMG_7055.JPG',
                        userImage: 'assets/mario.jpg',
                        userName: 'Mario'),
                  ],
                ),
              ),
              ...
              makeFeed(
                  ...
                  userImage: 'assets/god.jpg',
              feedTime: '1 hr ago',
              feedText: 'Lorem in the system.',
                  feedImage: 'assets/story/IMG_7055.JPG'
              ),
              makeFeed(
                  userName: 'Mad Max',
                  userImage: 'assets/mad.jpg',
                  feedTime: '3 hr ago',
                  feedText: 'Lorem in the system.',
                  feedImage: 'assets/story/IMG_7052.JPG'
              ),
              makeFeed(
                  userName: 'Prince Of Persia',
                  userImage: 'assets/prince.jpg',
                  feedTime: '1 hr ago',
                  feedText: 'Lorem in the system.',
                  feedImage: ''
              ),
  ...
  Widget makeStory({String storyImage, String userImage,String userName}) {
    return AspectRatio(aspectRatio: 1.6/2,
      child: Container(
        ...
        Row(
          ...
          children: <Widget>[
            ...
            IconButton(icon: Icon(Icons.more_horiz, size: 30,),
                onPressed: null, color: Colors.grey[600],)
          ],
        ),
        SizedBox(height: 20,),
          ...
          children: <Widget>[
            Row(
              children: <Widget>[
                ...
                child: makeLove(),),
                SizedBox(width: 5,),
                Text('1.2k', style: TextStyle(fontSize: 15,
